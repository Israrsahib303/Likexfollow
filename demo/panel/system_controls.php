        ...
        <div class="sys-card">
            ...
            <div class="card-body">
                <div class="backup-actions">
                    <a href="#" onclick="secureBackup('db_backup.php', false, false); return false;" class="btn-bk bk-sql">
                        <i class="fa-solid fa-database"></i>
                        <span>SQL Data</span>
                        <small>Database Only</small>
                    </a>
                    <a href="#" onclick="secureBackup('full_backup.php', true, false); return false;" class="btn-bk bk-zip">
                        <i class="fa-solid fa-file-zipper"></i>
                        <span>Full Site</span>
                        <small>All Files (Zip)</small>
                    </a>
                    <a href="#" onclick="secureBackup('generate_tree.php', false, true); return false;" class="btn-bk bk-tree">
...
<script>
function secureBackup(url, isFullBackup, isNewTab) {
    let pass = prompt("🔒 Restricted Area!\nBackup PIN enter karein:");
    
    if (pass === "67899876") {
        if (isFullBackup) {
            let confirmMsg = confirm('⚠️ Generating Full Backup takes time (30-60s).\nDo not close the tab until download starts.');
            if (!confirmMsg) return; // Agar user cancel karde toh ruk jao
        }
